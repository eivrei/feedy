...
<html lang="en">
  <head>
	...
	<script type="text/javascript" src="../../script/lecturer_statistics.js" charset="utf-8"></script>
  </head>
  ...
  <body>
	...
	<div class="container">
        ...
        <div class="container" id="statistics">
            <h2 id="lecture_name"></h2>
            <button type="button" class="btn btn-primary" id="generateButton" onclick="generateStatistics()">Generate statistics</button>
